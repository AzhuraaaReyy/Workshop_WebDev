<x-layouts.admin title="Manajemen Kategori">
    ...
    <div class="container mx-auto p-10">
        ...
        <div class="overflow-x-auto rounded-box bg-white p-5 shadow-xs">
            <table class="table">
                ...
                <tbody>
                    @forelse ($lokasi as $index => $lokal)
                    <tr>
                        <th>{{ $index + 1 }}</th>
                        <td>{{ $lokal->nama_lokasi }}</td>
                        <td>
                            <button class="btn btn-sm btn-primary mr-2" onclick="openEditModal(this)" data-id="{{ $lokal->id }}" data-nama="{{ $lokal->nama }}">Edit</button>
                            <button class="btn btn-sm bg-red-500 text-white" onclick="openDeleteModal(this)" data-id="{{ $lokal->id }}">Hapus</button>
                        </td>
                    </tr>
                    @empty
                    <tr>
    ...
    <dialog id="edit_modal" class="modal">
        <form method="POST" class="modal-box">
            ...
            <input type="hidden" name="lokasi_id" id="edit_category_id">
            ...
            <div class="form-control w-full mb-4">
                ...
                <input type="text" placeholder="Masukkan nama Lokasi" class="input input-bordered w-full" value="Lokasi Contoh" id="edit_category_name" name="nama_lokasi" />
            </div>
            <div class="modal-action">
                <button class="btn btn-primary" type="submit">Simpan</button>
    ...
    <dialog id="delete_modal" class="modal">
        <form method="POST" class="modal-box">
            ...
            <input type="hidden" name="lokasi_id" id="delete_category_id">
