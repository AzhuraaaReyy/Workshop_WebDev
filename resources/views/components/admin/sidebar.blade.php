<div class="drawer-side is-drawer-close:overflow-visible ">
    ...
    <div class="flex min-h-full flex-col items-start bg-gray-200 w-64 is-drawer-close:w-14 is-drawer-open:w-80">
        <div class="w-full flex items-center justify-center p-4">
            <img src="{{ asset('/storage/logo_bengkod.svg') }}" alt="Logo">
        </div>
        ...
        <ul class="menu w-full grow gap-1">
            ...
            <li class="{{ request()->routeIs('admin.lokasi.*') ? 'bg-gray-200 rounded-lg' : '' }}">
                <a href="{{ route('admin.lokasi.index') }}" class="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Event">
                    <!-- icon Event -->
