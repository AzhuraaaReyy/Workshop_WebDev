            ...
            <div class="card-body">
                ...
                <form id="eventForm" class="space-y-4" method="post"
                    ...
                    <div class="form-control">
                        ...
                        <select name="lokasi_id" class="select select-bordered w-full" required disabled>
                            <option value="" disabled selected>Pilih Lokasi</option>
                            @foreach ($lokasi as $lokal)
                            <option value="{{ $lokal->id }}"
                                {{ $lokal->id == $event->lokasi_id ? 'selected' : '' }}>
                                {{ $lokal->nama_lokasi }}
                            </option>
                            @endforeach
                    ...
                    <div id="imagePreview" class="overflow-hidden {{ $event->gambar ? '' : 'hidden' }}">
                        ...
                        <div class="avatar max-w-sm">
                            <div class="w-full rounded-lg">
                                @if ($event->gambar)
                                <img id="previewImg" src="{{ asset('./images/' . $event->gambar) }}"
                                    alt="Preview">
                                @else
